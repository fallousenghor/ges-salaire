...
class EmployeService {
    async getEmployesByEntreprisePaginated(entrepriseId, page = 1, limit = 10) {
        const skip = (page - 1) * limit;
        const [employes, total] = await Promise.all([
            db_1.default.employe.findMany({ where: { entrepriseId }, skip, take: limit, include: { entreprise: true, badge: true } }),
